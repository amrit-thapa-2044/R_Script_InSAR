...
ts_h5='timeseries.h5'
ts_era5='timeseries_ERA5.h5'
ts_era5_ramp='timeseries_ERA5_ramp.h5'
ts_era5_ramp_demErr='timeseries_ERA5_ramp_demErr.h5'
maskTempCoh_tif='maskTempCoh.tif'
...
for(i in 1:(dim(h5_raw)[3])){
  ...
  df_correlation$After_atm_cor_ERA5[i]=cor(as.vector(m_height),as.vector(a_era5[,,i]),use = "pairwise.complete.obs")
  df_correlation$After_atm_cor_ERA5_ramp[i]=cor(as.vector(m_height),as.vector(a_era5_ramp[,,i]),use = "pairwise.complete.obs")
  df_correlation$After_atm_cor_ERA5_ramp_dem_cor[i]=cor(as.vector(m_height),as.vector(a_era5_ramp_demErr[,,i]),use = "pairwise.complete.obs")
...
names(s_all_compare)=paste0(c('Raw','After_atm_cor_ERA5','After_atm_cor_ERA5_ramp','After_atm_cor_ERA5_dem_cor'),sep="_",data_date[indx_max_cor])
